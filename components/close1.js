...
const close1 = document.createElement('template')
close1.template = {}
...
close1.innerHTML = close1.template.css({}) + close1.template.html({})
customElements.define('close1-',
  class extends HTMLElement {
    constructor() {
      ...
      this
        ...
        .appendChild(close1.content.cloneNode(true))
